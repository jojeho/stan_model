  ...
  for(k in 1:K)
    {
      ...
      for(t in 1:T)
      {
        ob[1,t]=student_t_lpdf(y[t]|1,mu[1],sigma);
        ob[2,t]=student_t_lpdf(y[t]|1,mu[2],sigma);
        ob[3,t]=student_t_lpdf(y[t]|1,mu[3],sigma);
        ob[4,t]=student_t_lpdf(y[t]|1,mu[4],sigma);
      }
